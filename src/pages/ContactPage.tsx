          ...
          <Card className="border-border/50">
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div><Label>Message *</Label><Textarea required rows={5} placeholder="Tell us about your dream safari..." /></div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-3"><Mail className="h-4 w-4 shrink-0 text-primary" />info@tembosafari.com</div>
              </div>
            </div>
            <div>

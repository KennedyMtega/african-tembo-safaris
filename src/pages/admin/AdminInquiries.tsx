...
const statusColor: Record<string, string> = { "new": "bg-primary text-primary-foreground", "in_progress": "bg-safari-gold text-foreground", "resolved": "bg-safari-green text-primary-foreground" };
...
export default function AdminInquiries() {
  ...
  const { data: inquiries = [], isLoading } = useQuery({ queryKey: ["admin-inquiries"], queryFn: () => inquiryService.getAll() });
